...
.. csv-table::
   ...
   :strong:`BSD`                                                                                                                                                                                                                        
   FreeBSD :index:`\ <single: Platform; FreeBSD>`\ , >= 5.0, `X <http://www.freshports.org/sysutils/bareos-client/>`__, `X <http://www.freshports.org/sysutils/bareos-server/>`__, `X <http://www.freshports.org/sysutils/bareos-server/>`__
   OpenBSD, , X
   NetBSD,  , X                                                                                                                                                            
   :strong:`Unix`                                                                                                                                                                                                                       
...
The following tables summarize the packages that are available for individual Linux platforms.
Package names that do not contain the word **bareos** are required third party packages, provided by the Bareos project.
